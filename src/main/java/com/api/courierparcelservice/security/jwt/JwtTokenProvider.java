...
import com.api.courierparcelservice.exception.JwtAuthenticationException;
import com.api.courierparcelservice.security.JwtUserDetailsService;
...
public class JwtTokenProvider {
    ...
    public String createToken(CourEntity userEntity, List<RoleEntity> roleEntities) {
